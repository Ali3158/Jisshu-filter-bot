...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002419512905'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002419512905')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002419512905'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002192959182')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002419512905'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002437618797') # If anyone sends a request message to your bot, you will get it in this channel.
...
TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "14"))
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "14"))
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/52315673cf08797b0cc16-7c8459ff4af49fc63d.jpg https://graph.org/file/96432b7f0a4dda8f35df5-d1892521e9beb56d32.jpg https://graph.org/file/05039361a52f538d4c725-654aa7d4885708229c.jpg')).split()
